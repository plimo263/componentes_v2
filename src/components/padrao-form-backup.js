    ...
    constructor(props){
        ...
        switch(this.props.tipo){                
            ...
            case 'ar_oc_fornecedores_grifes': // Inicializa o formulario com ar/oc, fornecedores e grifes
                ...
                this.state.grifes = {total: this._formatar(grifes.total, true), selecionadas: grifesSelect};
                break;
            case 'lojas_mes_ano': // Inicializa as lojas do mes e ano
                //
                this.state.lojas = {total: this._formatar(lojas.total, true), selecionadas: this._obterDefault(lojas.selecionadas, lojas.total)};
                this.state.mes = this._initMes();
                this.state.anoDe = this._initAno(this.props.anoDe);
    ...
    render(){
        ...
        switch(tipo){
            ...
            case 'ar_oc_fornecedores_grifes': // Renderiza o tipos, fornecedores e grifes
                ...
                break;
            case 'lojas_mes_ano': // Renderiza lojas, meses e os anos
                renderizar = this._renderLojas().concat(this._renderAteOMes(1)).concat(this._renderAno(
                    this.state.anoDe, 1, 'anoDe', this.props.rotulos.anoDe
                ));
                break;
            ...
            case 'grupos_lojas_de_ate_de_venc_ate_venc': // Renderiza os grupos_lojas com 4 datas
                ...
                break;
            case 'lojas_sem_de_e_ate': // Renderiza as lojas sem de e ate
                renderizar = this._renderLojas();
                break;
    ...
    _enviar(){
        ...
        switch(this.props.tipo){
            ...
            default:
                ...
                break;
            case 'lojas':
                obj = this._enviarPadrao(); // Ele ignora grupos quando nao existem
                break;
            case 'grupos_lojas_ate_mes_ano':
            ...
            case 'ar_oc_fornecedores_grifes': // Valida os campos de ar/oc grifes e fornecedores
                ...
                break;
            case 'lojas_mes_ano': // Valida os campos lojas, mes e ano
                objLojas = this._validarLojas();
                if(!objLojas) {obj = false; return false;}
                obj = objLojas;
                //  Valida o mes
                if(!this._validarMes(this.state.mes)){ obj = false; return false;}
                //
                obj = Object.assign(obj, this._validarMes(this.state.mes));
                // Valida o ano
                if(!this._validarMes(this.state.anoDe)){ obj = false; return false;}
                obj = Object.assign(obj, this._validarAno(this.state.anoDe));
                break;
            case 'grupos_lojas_ano': // Valida os campos grupos/lojas e o ano
                obj = this._enviarGruposLojasAno();
                break;
            case 'lojas_ano': // Valida os campos lojas e ano
                obj = this._enviarLojasAno();
                break;
            case 'lojas_sem_de_e_ate': // Valida somente o campo das lojas sem de e ate
