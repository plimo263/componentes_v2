...
// Com limite de registros
export const comFiltroDeColuna = ()=>{
let cabe = ["EMPRESA", "LOJA", "DINHEIRO", "CARTAO DEBITO", "CARTAO CREDITO",  "VENDAS", "DESCONTO MEDIO"];
let corpo = [
    ["FMOREIRA - FIL 01", "0101", 200.0, 930.0, 1903.0, 8, 0.11703650680028632,], 
    ["FB - FIL 01", "0201", 573.0, 1735.0, 3590.0, 9, 0.15698188245691558,], 
...
return <Tabela filtroColuna={5} tamanho={400} cabe={cabe} corpo={corpo} />   
}

comFiltroDeColuna.story = {
    parameters: {
        docs: {
            storyDescription: 'Define um filtro de coluna com uma coluna padrão. Assim a busca fica mais rápida.'
        }
    }
};